...
class ReleasePaymentArgs:
    ...
    @property
    def abi_method_signature(self) -> str:
        return "release_payment(string)bool"
...
class EscrowVaultClient:
    ...
    def decode_return_value(
        self,
        method: typing.Literal["release_payment(string)bool"],
        return_value: algokit_utils.ABIReturn | None
    ) -> bool | None: ...
    @typing.overload
    def decode_return_value(
